...
async function getStaticProps() {
  // fetch data from an API
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Kenzie:lsnQHD1yhogaJjpK@cluster0.zqood4h.mongodb.net/meetups?retryWrites=true&w=majority", {
